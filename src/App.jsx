...
const saveKey = 'golf-slot-watch.saved'
const postKey = 'golf-slot-watch.posts'
const alerts = [
  {
    "id": "golf-slot-watch-1",
    "title": "空き枠 alert seed 1",
    "area": "名古屋",
    "category": "空き枠",
    "score": 95,
    "summary": "空き枠、安値、雨天キャンセル、天気、練習場を通知し、ゴルフ場予約と用品へ送客する。 空き枠の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "golf-slot-watch-2",
    "title": "安値 alert seed 2",
    "area": "東京",
    "category": "安値",
    "score": 92,
    "summary": "空き枠、安値、雨天キャンセル、天気、練習場を通知し、ゴルフ場予約と用品へ送客する。 安値の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
    ...
    "revenue": "用品 affiliate"
  },
  {
    "id": "golf-slot-watch-3",
    "title": "天気 alert seed 3",
    "area": "大阪",
    "category": "天気",
    "score": 89,
    "summary": "空き枠、安値、雨天キャンセル、天気、練習場を通知し、ゴルフ場予約と用品へ送客する。 天気の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "golf-slot-watch-4",
    "title": "練習場 alert seed 4",
    "area": "静岡",
    "category": "練習場",
    "score": 86,
    "summary": "空き枠、安値、雨天キャンセル、天気、練習場を通知し、ゴルフ場予約と用品へ送客する。 練習場の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">ゴルフ場空き枠・安値・天気通知</p>
          <h1>Golf Slot Watch</h1>
          <p className="lead">空き枠、安値、雨天キャンセル、天気、練習場を通知し、ゴルフ場予約と用品へ送客する。</p>
        </div>
        <aside className="hero-panel">
          <span>golfslot.jp / golf-slot-watch</span>
